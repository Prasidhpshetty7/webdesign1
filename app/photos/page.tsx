...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://prasidh-p-shetty.com/photos"),
  description: "Explore photos taken by Prasidh P Shetty",
  openGraph: {
    title: "Photos | Prasidh P Shetty",
    url: "https://prasidh-p-shetty.com/photos",
    description: "Explore photos taken by Prasidh P Shetty",
    images:
      "https://res.cloudinary.com/prasidh-p-shetty/image/upload/v1692635149/prasidh-p-shetty/photos.png",
  },
};
