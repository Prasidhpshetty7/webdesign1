...
```js
git clone https://github.com/Prasidhpshetty7/prasidh-p-shetty.com.git

cd prasidh-p-shetty.com
...
This portfolio is MIT-licensed so you are free to use it as an inspiration or you can just copy the whole thing (excluding my personal content of course), I don't really mind. Just make sure you link back to [prasidh-p-shetty.com][site] on the footer section as attribution to the original source.
...
[env-example]: https://github.com/Prasidhpshetty7/prasidh-p-shetty.com/blob/main/.env.example
[localhost]: http://localhost:3000
[localhost-studio]: http://localhost:3000/studio
[env-api]: https://github.com/Prasidhpshetty7/prasidh-p-shetty.com/blob/main/lib/env.api.ts
